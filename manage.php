      ...
      <?php
        ...
        if(isset($_GET['validate'])){
          ...
          if ($conn->query($sql) === TRUE) {
            ...
            echo '<br>';
            echo 'The coin from ' . $selectedCountry . ' (' . $selectedYear . ') - "' . $selectedEvent . '" has been ADDED with state ' . $selectedState . '';
            echo '</div>';
          } else {
            echo '<br>';
        ...
        if(isset($_GET['update'])){
          ...
          if ($conn->query($sql) === TRUE) {
            ...
            echo '<strong>SUCCESS</strong>';
            echo '<br>';
            echo 'The coin from ' . $selectedCountry . ' (' . $selectedYear . ') - "' . $selectedEvent . '" has been UPDATED with state ' . $selectedState . '';
            echo '</div>';
          } else {
            echo '<br>';
            echo '<div class="alert alert-danger fade in">';
        ...
        if(isset($_GET['delete'])){
          ...
          if ($conn->query($sql) === TRUE) {
            ...
            echo '<strong>SUCCESS</strong>';
            echo '<br>';
            echo 'The coin from ' . $selectedCountry . ' (' . $selectedYear . ') - "' . $selectedEvent . '" has been REMOVED from your collection';
            echo '</div>';
          } else {
            echo '<br>';
            echo '<div class="alert alert-danger fade in">';
