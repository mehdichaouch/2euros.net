...
<html lang="en">
  ...
  <div class="container">
    ...
    <p>Track your progress here (results may vary due to DB modifications overtime)</p> 
      ...
      $sql_total_coins = "SELECT COUNT(*) FROM Coins";
      $result_total_coins = mysql_query($sql_total_coins);
      $total_coins = mysql_fetch_array($result_total_coins);
      ...
      $result_user_total = mysql_query($sql_user_total);
      $total_user = mysql_fetch_array($result_user_total);

      $value_total = (int)$total_coins[0];
      ...
      echo '<div class="panel-heading"><b>Overall</b></div>';
      ...
      $money = round((int)$total_user[0]*2);
